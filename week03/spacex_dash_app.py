...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        filtered_df = filtered_df[filtered_df['Launch Site']==entered_site].groupby(['class']).count()
...
def get_scatter_plot(entered_site, entered_payload):
    ...
    filtered_df = filtered_df[filtered_df['Payload Mass (kg)'].isin(range(entered_payload[0], entered_payload[1]))]
